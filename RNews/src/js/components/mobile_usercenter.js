...
export default class MobileUserCenter extends React.Component {
	...
	componentDidMount() {
		...
		fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=getuc&userid=19179",myFetchOptions)
		.then(response=>response.json())
		.then(json=>{
			this.setState({usercollection:json});
		});
		fetch("http://newsapi.gugujiankong.com/Handler.ashx?action=getusercomments&userid=19179",myFetchOptions)
		.then(response=>response.json())
		.then(json=>{
